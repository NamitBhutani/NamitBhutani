...
### 💻 My toolbelt
I spend most of my time writing **C++** and **Python**, but I'm completely comfortable jumping into Go, Java, or TypeScript when the backend needs it.
* **Graphics & Compute:** OpenGL, Vulkan, CUDA, Falcor, Houdini HDK, Unreal Engine, GLSL/HLSL, Slang
* **Systems & Data:** Linux, Docker, PostgreSQL, Redis, CI/CD, Vector Databases
* **Environment:** NixOS (and yes, I probably spend too much time tweaking my system config).

### 📫 Let's chat
Always down to talk rendering algorithms, scalable system architecture, or NixOS flakes. 

[namit.bhut@gmail.com](mailto:namit.bhut@gmail.com) • [LinkedIn](https://linkedin.com/in/namitbhutani) • [Twitter](https://x.com/intellomaniac_)
